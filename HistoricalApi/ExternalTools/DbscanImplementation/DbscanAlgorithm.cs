...
using ExternalTools.DbscanImplementation.Eventing;
using ExternalTools.DbscanImplementation.ResultBuilding;


// Yanked from: https://github.com/yusufuzun/dbscan


namespace ExternalTools.DbscanImplementation
{
    /// <summary>
